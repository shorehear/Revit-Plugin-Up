...
namespace Elements_Copier
{
    public class SelectionElementsViewModel //: INotifyPropertyChanged
    {
            ...
            else if (_continueSelecting)
            {
                try
                {
                    ...
                    if (pickedRef != null)
                    {
                        ...
                        {
                            if(!_selectedElementsData.SelectedElements.Contains(selectedElement))
                            {
                                _selectedElementsData.SelectedElements.Add(selectedElement);
        ...
        private void EndSelecting(object parameter)
        {
            ...
            foreach (var element in _selectedElementsData.SelectedElements)
            {
